...
public class WheelTime {
    ...
    public void setPicker(int year, final int month, int day, int h, int m, int s) {
      ...
      /*  final Context context = view.getContext();*/
        ...
        wv_year.setCurrentItem(wv_year.getItemPosition(currentYear));// 初始化时显示的数据
        ...
        wv_month.setCurrentItem(wv_month.getItemPosition(currentMonth));
     /*   wv_month.setLabel(context.getString(R.string.pickerview_month));*/
        ...
        wv_day.setCurrentItem(wv_day.getItemPosition(currentDay));
       /* wv_day.setLabel(context.getString(R.string.pickerview_day));*/

        wv_day.setGravity(gravity);
        //时
        int curentYear = wv_year.getCurrentItem() + wv_year.getMinValue();
        int curentMonth = wv_month.getCurrentItem() + wv_month.getMinValue();
        int currentDay = wv_day.getCurrentItem() + wv_day.getMinValue();
        ...
        } else if(curentYear == startYear && curentMonth == startMonth && currentDay == startDay) {
            wv_hours.setAdapter(new NumericWheelAdapter(startHour, 23));
        }else if(curentYear == endYear && curentMonth == endMonth && currentDay == endDay){
      ...
      /*  wv_hours.setLabel(context.getString(R.string.pickerview_hours));// 添加文字*/
        ...
        wv_hours.setCurrentItem(wv_hours.getItemPosition(h));
        wv_hours.setGravity(gravity);
        //分
        int curentHour = h;
        wv_mins = (WheelView) view.findViewById(R.id.min);
        Log.d("BTT","curentHour:"+curentHour + "");
        ...
        }else if(curentYear == startYear && curentMonth == startMonth && currentDay == startDay && curentHour == startHour) {
            Log.d("BTT","2");
            wv_mins.setAdapter(new NumericWheelAdapter(startMin, 59));
        }else if(curentYear == endYear && curentMonth == endMonth && currentDay == endDay && curentHour == endHour){
            wv_mins.setAdapter(new NumericWheelAdapter(0, endMin));
        }else{
            wv_mins.setAdapter(new NumericWheelAdapter(0, 59));
        }
       /* wv_mins.setLabel(context.getString(R.string.pickerview_minutes));// 添加文字*/
        wv_mins.setCurrentItem(wv_mins.getItemPosition(m));
        ...
        if(startYear == endYear && startMonth == endMonth && startDay == endDay && startHour == endHour && startMin == endMin){
            if(startseconds <= endseconds){
                wv_seconds.setAdapter(new NumericWheelAdapter(startseconds, endseconds));
            }else {
                wv_seconds.setAdapter(new NumericWheelAdapter(0, 59));
            }
        }else if(curentYear == startYear && curentMonth == startMonth
                && currentDay == startDay && curentHour == startHour && curentMin == startMin) {
            wv_seconds.setAdapter(new NumericWheelAdapter(startseconds, 59));
        }else if(curentYear == endYear && curentMonth == endMonth
                && currentDay == endDay && curentHour == endHour && curentMin == endMin){
            wv_seconds.setAdapter(new NumericWheelAdapter(0, endseconds));
        }else {
            wv_seconds.setAdapter(new NumericWheelAdapter(0, 59));
        }
       /* wv_seconds.setLabel(context.getString(R.string.pickerview_seconds));// 添加文字*/
        wv_seconds.setCurrentItem(wv_seconds.getItemPosition(s));
        wv_seconds.setGravity(gravity);
        int curentsends = wv_seconds.getCurrentItem() + wv_seconds.getMinValue();
        Log.d("BTT","startYear:"+startYear+" startM:"+startMonth+" startD:"+startDay+"  startHour:"+startHour+" startMin:"+startMin +" startSenc:"+startseconds);
        Log.d("BTT","endYear:"+endYear+" endM:"+endMonth+" endD:"+endDay+"  endHour:"+endHour+" endMin:"+endMin+"  endsenc:"+endseconds);
        Log.d("BTT","curentyear:"+curentYear+"  curentM:"+curentMonth +" currenD:"+currentDay+"  currentHour:"+curentHour +"  currentMin:"+curentMin +" curentsenc:"+curentsends);
        // 添加"年"监听
        OnItemSelectedListener wheelListener_year = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                ...
                if(wv_month.getAdapter().getItemsCount() == 1){
                    wv_month.setCurrentItem(0);
                }
                if(wv_day.getAdapter().getItemsCount() == 1){
                    wv_month.setCurrentItem(0);
                }

                int currentMonth = wv_month.getCurrentItem() + wv_month.getMinValue();
                int currentDay = wv_day.getCurrentItem() + wv_day.getMinValue();
                ...
                int currentHour = wv_hours.getCurrentItem()+wv_hours.getMinValue();
                if(startYear == endYear && startMonth == endMonth && startDay == endDay && startHour == endHour){
                    if(startMin <= endMin){
                        wv_mins.setAdapter(new NumericWheelAdapter(startMin, endMin));
                ...
                int currentMin = wv_mins.getCurrentItem() + wv_mins.getMinValue();
                Log.d("BTT","YearSelect currentYear:"+currentYear+" currentMonth:" +currentMonth+
                        " curentDay:"+currentDay+"  currentHour:"+currentHour +"  currentMin:"+currentMin);
                if(startYear == endYear && startMonth == endMonth && startDay == endDay && startHour == endHour && startMin == endMin){
                    if(startseconds <= endseconds){
                        wv_seconds.setAdapter(new NumericWheelAdapter(startseconds, endseconds));
                        ...
                        && currentDay == startDay && currentHour == startHour && currentMin == startMin){
                    wv_seconds.setAdapter(new NumericWheelAdapter(startseconds, 59));
                    wv_seconds.setCurrentItem(0);
                }else if(currentYear == endYear && currentMonth == endMonth
                        && currentDay == endDay && currentHour == endHour && currentMin == endMin){
                    wv_seconds.setAdapter(new NumericWheelAdapter(0, endseconds));
                    wv_seconds.setCurrentItem(0);
                }else {
                    wv_seconds.setAdapter(new NumericWheelAdapter(0, 59));
        ...
        OnItemSelectedListener wheelListener_month = new OnItemSelectedListener() {
            ...
            public void onItemSelected(int index) {
                ...
                int currentYear = wv_year.getCurrentItem() + wv_year.getMinValue();
                int currentMonth = wv_month.getCurrentItem() + wv_month.getMinValue();
                int currentDay = wv_day.getCurrentItem() + wv_day.getMinValue();
                if(startYear == endYear && startMonth == endMonth && startDay == endDay){
                    if(startHour <= endHour){
                ...
                wv_hours.setCurrentItem(0);
                int currentHour = wv_hours.getCurrentItem()+wv_hours.getMinValue();
                if(startYear == endYear && startMonth == endMonth && startDay == endDay && endHour == startHour){
                    if(startMin <= endMin){
                        wv_mins.setAdapter(new NumericWheelAdapter(startMin,endMin));
                        wv_mins.setCurrentItem(0);
                    }else {
                ...
                wv_mins.setCurrentItem(0);
                int currentMin = wv_mins.getCurrentItem() + wv_mins.getMinValue();
                Log.d("BTT","MonthSelect currentYear:"+currentYear+" currentMonth:" +currentMonth
                        +" curentDay:"+currentDay+"  currentHour:"+currentHour +"  currentMin:"+currentMin);
                if(startYear == endYear && startMonth == endMonth && startDay == endDay && endHour == startHour && startMin == endMin){
                    if(startseconds <= endseconds){
                        wv_seconds.setAdapter(new NumericWheelAdapter(startseconds, endseconds));
                        wv_seconds.setCurrentItem(0);
                    }else {
        ...
        OnItemSelectedListener wheelListener_day = new OnItemSelectedListener(){
            ...
            public void onItemSelected(int index) {
                ...
                int currentMin = wv_mins.getCurrentItem() + wv_mins.getMinValue();
                Log.d("DaySelect","currentYear:"+currentYear+" currentMonth:" +currentMonth+"curentMonth:"
                        +currentMonth+" curentDay:"+currentDay+"  currentHour:"+currentHour +"  currentMin:"+currentMin);
                if(startYear == endYear && startMonth == endMonth && startDay == endDay && startHour == endHour && startMin == endMin){
                    if(startseconds <= endseconds){
                        wv_seconds.setAdapter(new NumericWheelAdapter(startseconds, endseconds));
                        wv_seconds.setCurrentItem(0);
        ...
        OnItemSelectedListener wheelListener_hour = new OnItemSelectedListener(){
            ...
            public void onItemSelected(int index) {
                ...
                int currentMin = wv_mins.getCurrentItem() + wv_mins.getMinValue();
                Log.d("HourSelect","currentYear:"+currentYear+"curentMonth:" +currentMonth
                        +" curentDay:"+currentDay+"  currentHour:"+currentHour +"  currentMin:"+currentMin);
                if(startYear == endYear && startMonth == endMonth && startDay == endDay && startHour == endHour && startMin == endMin){
                    if(startseconds <= endseconds){
                        wv_seconds.setAdapter(new NumericWheelAdapter(startseconds, endseconds));
        ...
        OnItemSelectedListener wheelListener_min = new OnItemSelectedListener(){
            ...
            public void onItemSelected(int index) {
                ...
                int currentHour = wv_hours.getCurrentItem()+wv_hours.getMinValue();
                int currentMin = wv_mins.getCurrentItem() + wv_mins.getMinValue();
                Log.d("MinsSelect","currentYear:"+currentYear+" currentMonth:" +currentMonth+"curentMonth:"
                        +currentMonth+" curentDay:"+currentDay+"  currentHour:"+currentHour +"  currentMin:"+currentMin);
                if(startYear == endYear && startMonth == endMonth && startDay == endDay && startHour == endHour && startMin == endMin){
                    if(startseconds <= endseconds){
                        wv_seconds.setAdapter(new NumericWheelAdapter(startseconds, endseconds));
...
//                    .append(wv_seconds.getCurrentItem());
//        }
        sb.append((wv_year.getCurrentItem() + wv_year.getMinValue())).append("-")
                    .append((wv_month.getCurrentItem() + wv_month.getMinValue())).append("-")
                    .append((wv_day.getCurrentItem() + wv_day.getMinValue())).append(" ")
                    .append(wv_hours.getCurrentItem()+ wv_hours.getMinValue()).append(":")
                    .append(wv_mins.getCurrentItem() + wv_mins.getMinValue()).append(":")
                    .append(wv_seconds.getCurrentItem() + wv_seconds.getMinValue());
        return sb.toString();
    }
    ...
    public void setRangDate(Calendar startDate, Calendar endDate) {
        ...
        if (startDate == null && endDate != null) {
            ...
            int seconds = endDate.get(Calendar.SECOND);
            if (year > startYear) {
                this.endYear = year;
                this.endMonth = month;
                this.endDay = day;
            ...
            this.startseconds = startDate.get(Calendar.SECOND);
            this.endseconds = endDate.get(Calendar.SECOND);
        }
